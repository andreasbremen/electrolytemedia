...
function calc_dynamicViscosityLowPressure
...
<p>
The used formula are based on the method of ChunGfun et al (1984, 1988) referred to in ref [1] chapter 9.
The formula 9-4.10 is the one beinGfun used. The Formula is given in non-SI units, the followinGfun conversion constants were used to
...
<h4>References:</h4>
<p>
[1] Bruce E. PolinGfun, John E. Prausnitz, John P. O'Connell, \"The Properties of Gases and Liquids\" 5th Ed. Mc Graw Hill.
</p>
...
end calc_dynamicViscosityLowPressure;
