...
record UserInterface
  ...
  Media.GasPhase.Common.GasDataRecord[nG] datag
    "Species data record" annotation (choicesAllMatching=true, Dialog(
      enable=GasModel == Media.Common.Types.GasModel.Ideal,
      tab="Gas phase",
      group="Ideal gas"));


  Media.GasPhase.Common.InteractionDataRecord interactionG
    "Interaction data record" annotation (choicesAllMatching=true, Dialog(
      enable=GasModel == Media.Common.Types.GasModel.PengRobinson,
      tab="Gas phase",
      group="Peng Robinson gas"));
  ...
  //Reaction
  parameter Integer nR_GL = 0 "Number of gas-liquid equilibria" annotation(Dialog(tab="Reaction"));
  ...
  parameter Integer nR_L = 0 "Number of dissociation equilibria" annotation(Dialog(tab="Reaction"));
  ...
  //General
  String mediumName = "Name of the medium" "Name of medium written as a string" annotation(Dialog(tab="General"));
