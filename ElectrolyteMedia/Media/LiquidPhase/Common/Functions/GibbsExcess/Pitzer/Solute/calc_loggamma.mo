...
//   Real[nLifun,nLifun] theta_ij=calc_theta_ij(T);
  Real[nLifun,nLifun] lambda_ij=calc_lambda_ij(T);
  Real[nLifun,nLifun,nLifun] psi_ijk=calc_psi_ijk(T);
  Real[nLifun,nLifun,nLifun] zeta_ijk=calc_zeta_ijk(T);
  Real F=calc_F(T,p,X);
  Real[nLifun,nLifun] C_ij=calc_C_ij(T);
  Real[nLifun,nLifun] B_ij=calc_B_ij(T, X);
  Real[nLifun,nLifun] Phi_ij=calc_Phi_ij(T,p,X);
  Real Z=calc_Z(X);
